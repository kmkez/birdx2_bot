...
console.log(`
    L        OOO   RRRR   DDDD    BBBBB   EEEEE  AAAAA  SSSSS  TTTTT
    L       O   O  R   R  D   D   B    B  E      A   A  S        T
    L       O   O  RRRR   D   D   BBBBB   EEEE   AAAAA   SSS     T
    L       O   O  R  R   D   D   B    B  E      A   A      S    T
    LLLLLL   OOO   R   R  DDDD    BBBBB   EEEEE  A   A  SSSSS    T
   `);

   
   console.log(` Join t.me/lordbeastop for more such scripts..
   `);

   console.log(` TON Address - UQCTPmyv7A3NOpJtWTUHK8PrMrWE1eWU9ZdSuBbE4dHcBlzz
   `);

   
   console.log(` EVM Address - 0xC0FA41f451425173A74dff4D6ae4AdC48b86Ad0B
    `);
